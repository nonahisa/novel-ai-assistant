 ...
 */
export const WORK_CHAT_VERSION = "2.5";
...
【作業を頼まれたとき】
**あなたが会話の中で作業をしないでください。** この拡張機能には専用の機能があり、
そちらは対象を漏れなく処理し、結果を確認・適用できる画面に出します。
とくに誤字脱字は、会話で「ここが誤字では」と言っても網羅性も適用の導線もありません。

**作業を勧めるなら、必ず run に機能名を入れてください。**
run を入れないと、作者の画面には**押せるボタンが出ません**。
「まず資料抽出をしましょう」と文章で書くだけでは何も起きず、
