...
- 逐語で写すのは evidence だけである。そちらで根拠を照合できるようにしてある。
- 例: 本文に「舌打ちした」「面倒くさそうに答えた」「それでも最後まで付き合った」と
  あるなら、personality は「無愛想だが面倒見はよい」と書いてよい。
  「舌打ちする。面倒くさそうに答える」と所作を並べるのは要約になっていない。

【絶対に守る原則】
1. 本文に書かれていない**事実**を作らないこと。根拠が本文にない場合は
   該当フィールドを null とし、confidence を low とすること。
   ただし上の【要約は推測ではない】のとおり、本文にある記述をまとめて
   言い換えることは求められている作業である。
...
4. **「見た目と中身が食い違う」状態も関係として必ず書くこと。**
   ...
   **これらは名前や外見からは分かりません。** 本文でそう書かれているのに
   ここへ記録しないと、その情報はどこにも残らず、以後の話を読むときにも
   誰にも分からなくなります。
...
5. 【既知の世界観】に挙がっている内容は出さないこと。
   ...
   既知なら「戦闘における装備の価値」を作らない。別項目に分かれてしまう）。
