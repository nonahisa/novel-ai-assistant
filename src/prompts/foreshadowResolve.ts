 ...
 */
// 1.1: 「張った箇所そのものを回収と見なさない」を明示した。実データで、
//      却下8件のうち5件が `planted_echo`（張った文をそのまま回収として
//      挙げていた）だった。渡す一覧に「張った箇所：「…」」と書いておきながら、
...
【回収と見なさないもの】
- **上の「張った箇所」に書かれている文そのもの。** それは伏線を置いた場所で
  あって、回収ではありません。同じ話の中に張った箇所が含まれることがあります
- 同じ言葉や人物が出てくるだけ
