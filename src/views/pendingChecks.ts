...
export const PENDING_CHECKS: readonly PendingCheckSection[] = [
  ...
  },
  {
    id: "F-80",
    title: "提供先別の設定資料書き出し",
    commands: ["novelai.exportSettingsForAudience"],
    count: 8,
  },
  {
    id: "F-81",
  ...
  },
  {
    id: "F-83",
    title: "AI呼び出しの全体キュー",
    commands: ["novelai.checkTypos", "novelai.checkContradictions"],
    count: 6,
  },
  {
    id: "F-84",
    title: "出力上限と関所の整合",
    commands: ["novelai.checkTypos", "novelai.openChat"],
    count: 4,
  },
  {
    id: "F-85",
  ...
  },
  {
    id: "F-87",
    title: "基盤レビュー3件の修正",
    commands: ["novelai.measureContext", "novelai.checkTypos"],
    count: 5,
  },
  {
    id: "F-88",
  ...
  {
    id: "F-91",
    title: "読者の反応の台帳・手入力・切り詰めの案内",
    commands: ["novelai.recordReaderStats", "novelai.showWritingStats", "novelai.openChatPanel"],
    count: 6,
  },
  {
    id: "F-92",
...
/** 残っている項目の総数 */
export const PENDING_CHECK_TOTAL = 735;
