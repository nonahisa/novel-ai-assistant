      ...
      */
      {
        ...
        items: [
          ...
          */
          ...
          /*
            旧3つの入口は**消さずに隠す**（6.108.6）。コマンドパレットと
            既存の呼び出し元（作品一覧の節点・案内の札）から、これまでどおり
            動く。詳細メニューには上の「ターゲット読者」だけが出る。
          */
          {
            kind: "action",
          ...
          // ターゲットシート（設計書6.108）。「ターゲット読者」の
          // 「いまの材料でシートを作り直す」と同じ紙を作る
          {
            kind: "action",
            ...
            detail:
              ...
              "・読者層を広げる・絞る の向かう先\n\n" +
              "・3つの輪・タイトルの適合度も並ぶ\n\n" +
              "・先に「ターゲット読者」で狙いか読者像を決める\n\n" +
              "・「狙い」の欄は作者が書く（作り直しても残る）\n\n" +
              "・作り直すたびに控えが残り、推移として並ぶ\n\n" +
              "AIは呼ばない。本文は書き換えない。",
          },
          // 3つの輪（設計書6.101）。「ターゲット読者」の選択肢
          // 「3つの輪の紙を開く」からも開く（実績と近づける道まで並べた紙）
          {
            kind: "action",
