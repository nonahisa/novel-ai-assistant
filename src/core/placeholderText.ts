...
const PLACEHOLDERS = [
  ...
  "該当なし",
  // プロット逸脱検知で実機に返ってきた（2026-09-22、さくらのAI
  // `preview/gemma-4-31B-it`）。「該当なし」を配列の要素で表そうとした形
  "該当箇所なし",
  // 逸脱検知のプロンプト（P-11 v1.2）に「空の配列で返す」と書いたので、
  // その言葉が中身として返ってくる前提で並べておく（CLAUDE.md 失敗3）
  "空の配列",
  "空配列",
  "そのまま",
  "-",
