...
**書くこと以外を、引き受けます。** 小説の執筆で積み重なる「書く前」と「書いた後」の仕事——プロットづくり、設定資料づくり、見直し、投稿の準備、電子書籍・PDFでの出版——を、**原稿には手を触れないAI**と一緒に片づけるための拡張機能です。

このリポジトリの版：**0.33.1**（0.32.1〜0.32.14を含む配布版）。Marketplace に出ている版はこれより遅れることがあります。
