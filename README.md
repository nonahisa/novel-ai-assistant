...
このリポジトリの版：**0.22.11**（入力が黙って切り捨てられうる見積りと、抽出のたびに矛盾検知のキャッシュが飛んでいたのを直しました）。Marketplace に出ている版はこれより遅れることがあります。
...
**AIは原稿（本文）を勝手に書き換えません。** 指摘や提案は必ず作者が確認してから反映します。使うAIは Ollama・LM Studio（無料・手元のパソコン）、Gemini、さくらのAI Engine、ChatGPT、Claude から選べます。
