...
現在の配布版：**0.2.0**（プロットの逆算、AIとの相談、表記ゆれ検知、執筆統計を追加）
...
| 整える | プロットを本文から逆算する。各話あらすじ・作品紹介文・キャッチコピーを作る |
...
```powershell
gh release download v0.2.0 --repo nonahisa/novel-ai-assistant --pattern "novel-ai-assistant-0.2.0.vsix" --clobber
code --install-extension ".\novel-ai-assistant-0.2.0.vsix" --force
```
