...
現在の配布版：**0.4.0**（相談が質問に近い場面を作品全体から探すようになりました）
...
```powershell
gh release download v0.4.0 --repo nonahisa/novel-ai-assistant --pattern "novel-ai-assistant-0.4.0.vsix" --clobber
code --install-extension ".\novel-ai-assistant-0.4.0.vsix" --force
```
