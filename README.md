...
現在の配布版：**0.3.0**（各話の盛り上がりを見る感情曲線を追加）
...
```powershell
gh release download v0.3.0 --repo nonahisa/novel-ai-assistant --pattern "novel-ai-assistant-0.3.0.vsix" --clobber
code --install-extension ".\novel-ai-assistant-0.3.0.vsix" --force
```
