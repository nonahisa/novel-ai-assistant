...
現在の配布版：**0.6.18**（実際に使って見つかった不具合の修正）
...
```powershell
gh release download v0.6.18 --repo nonahisa/novel-ai-assistant --pattern "novel-ai-assistant-0.6.18.vsix" --clobber
code --install-extension ".\novel-ai-assistant-0.6.18.vsix" --force
```
