...
このリポジトリの版：**0.19.1**（名前の書き換えを直しました）。Marketplace に出ている版はこれより遅れることがあります。
...
> **まだ実機で確かめていない画面です**（0.19.0で追加）。とくに縦書きで日本語を打つときの入力（IME）の効き方は、実際に打ってみるまで分かりません。**まずは作品のコピーでお試しください。**
