...
このリポジトリの版：**0.18.1**（実際に使って見つかった不具合の修正）。Marketplace に出ている版はこれより遅れることがあります。
...
**AIは原稿（本文）を勝手に書き換えません。** 指摘や提案は必ず作者が確認してから反映します。使うAIは Ollama（無料・ローカル）、Claude、ChatGPT、Gemini、さくらのAI Engine から選べます。
