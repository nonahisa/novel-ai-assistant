...
抽出したJSONから読むための資料集を書き出すのが「**設定資料集を出力する**」です。JSONを手直ししたあとや、人物をまとめたあと・更新を反映したあとに実行すると、`characters.md`・`abilities.md`・`locations.md`が最新の内容になります。AIは呼びません。
...
こちらは項目ではなく、**文章のメモ**を書かせる機能です。観点を入れて「掘り下げる」を押すと、AIがその設定について本文から読み取れることを書きます。
