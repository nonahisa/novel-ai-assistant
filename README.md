...
このリポジトリの版：**0.26.2**（名前の点検と付け替え・生成文書の実ファイル化。0.26.0＝VSIX配布版）。Marketplace に出ている版はこれより遅れることがあります。
...
| 資料をためる | 本文から登場人物・場所・スキル・組織・世界観を抽出して設定資料にする。**名前の点検**（響きの近い名前を見つける・候補を出す・姓名と別名をまとめて付け替える） |
